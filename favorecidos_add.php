                    ...
                    <div class="tab-content" id="tabdados_favorecidos">
                        <div class="tab-pane fade show active" id="dados_favorecidos" role="tabpanel" aria-labelledby="dados_favorecidos">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-check-input" type="radio" name="tipo_favorecidos" id="tipo_favorecidos" value="2">
                                <label class="form-check-label" for="tipo_favorecidos">
                                    Saída
                                </label>
                            </div>
                            <input type="hidden" id="id_favorecidos" value="<?php echo isset($id) ? $id : '' ?>" />
                            <input type="hidden" id="usuario_id_favorecidos" name="usuario_id_favorecidos" value="<?php echo isset($usuario_id) ? $usuario_id : '' ?>" />
                        </div>
                    </div>
                    <br>
                    <div>
