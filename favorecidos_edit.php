...
<div class="container">
    <div class="row">
        <div class="col-md-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#" title="Home" id="home_index_favorecidos"><i class="fas fa-home"></i>
                                    <span>Home</span></a></li>
                            <li class="breadcrumb-item"><a href="#" title="favorecidos" id="favorecidos_index"><i class="fas fas fa-tag"></i> <span>favorecidos</span></a></li>
            ...
            ?>
            <div class="alert alert-info alert-dismissible fade show" style="display: none;" id="div_mensagem_registro_favorecidos">
                <button type="button" class="btn-close btn-sm" aria-label="Close" id="div_mensagem_registro_botao_favorecidos"></button>
                <p id="div_mensagem_registro_texto_favorecidos"></p>
            </div>
            <hr>
            <div class="col-md-12">
                <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="favorecidos_dados" role="form" action="">
                    ...
                    <div class="tab-content" id="tabdados_favorecidos">
                        <div class="tab-pane fade show active" id="dados_favorecidos" role="tabpanel" aria-labelledby="dados_favorecidos">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="form-check-label" for="tipo_favorecidos">
                                    Entrada
                                </label>
                                <input class="form-check-input" type="radio" name="tipo_favorecidos" id="tipo_favorecidos" value="2" <?php echo (isset($resultado['tipo']) && $resultado['tipo'] == 2) ? 'checked' : ''; ?> disabled>
                                <label class="form-check-label" for="tipo_favorecidos">
                                    Saída
                                </label>
                            </div>
                            <input type="hidden" id="id_favorecidos" name="id_favorecidos" value="<?php echo isset($id) ? $id : '' ?>" />
                        </div>
                    </div>
                    <br>
                    <div>
                        <button type="button" class="btn btn-primary" id="botao_salvar_favorecidos">Salvar</button>
                        <button type="reset" class="btn btn-secondary" id="botao_limpar_favorecidos">Limpar</button>
                    </div>
                </form>
            </div>
            <div>
                <input type="hidden" id="pagina_favorecidos" name="pagina_favorecidos" value="<?php echo isset($pagina) ? $pagina : '' ?>" />
...
<!--modal de salvar-->
<div class="modal fade" id="modal_salvar_favorecidos" tabindex="-1" aria-labelledby="logoutlabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="modal_salvar_sim_favorecidos">Sim</button>
